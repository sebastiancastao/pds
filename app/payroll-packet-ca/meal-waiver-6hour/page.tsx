...
export default function MealWaiver6HourPage() {
  ...
  const handleSave = async () => {
    ...
    if (!acknowledges) {
      alert(isRejecting ? 'Please check the box confirming you are declining this waiver' : 'Please check the acknowledgment box');
      return;
    }
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <button
              type="button"
              onClick={() => { setDecision('waived'); setAcknowledges(false); }}
              style={{
                flex: '1 1 220px',
                textAlign: 'left',
                padding: '14px 16px',
            ...
            <button
              type="button"
              onClick={() => { setDecision('rejected'); setAcknowledges(false); }}
              style={{
                flex: '1 1 220px',
                textAlign: 'left',
                padding: '14px 16px',
        ...
        {isRejecting ? (
          <div style={{
            ...
            <p style={{ marginBottom: '16px', fontWeight: 'bold', color: '#b71c1c' }}>6 Hour Meal Break Waiver — Declined</p>
            ...
            <label style={{ display: 'flex', alignItems: 'start', gap: '12px', cursor: 'pointer' }}>
              ...
              {isRejecting ? (
                <span style={{ fontSize: '14px', color: '#333', lineHeight: '1.5' }}>
                  <strong>I confirm my decision to decline</strong> this meal period waiver. I am NOT giving up this meal period and will take my full, uninterrupted meal break for shifts of 6 hours or less.
                </span>
              ) : (
                <span style={{ fontSize: '14px', color: '#333', lineHeight: '1.5' }}>
