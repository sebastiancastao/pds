...
export async function GET() {
  try {
    const pdfPath = join(process.cwd(), 'CA TEMPORARY EMPLOYMENT SERVICES AGREEMENT letter (Final)(2508529.8).docx.pdf');
