...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.warn('[FW4 NY] Failed to add Employee Date field', error);
    }
    ...
    const removeFieldFromPdf = (fieldName: string) => {
      try {
        ...
        console.warn(`[FW4 NY] Field not found or removal failed: ${fieldName}`, error);
      }
    };
    ...
    console.error('FW4 NY PDF generation error:', error);
