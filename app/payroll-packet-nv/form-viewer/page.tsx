...
const NV_FORMS: FormSpec[] = [
  ...
  { id: 'temp-employment-agreement', display: 'Temporary Employment Services Agreement', requiresSignature: true, apiOverride: '/api/payroll-packet-nv/temp-employment-agreement' },
...
const EMPLOYEE_INFO_STORAGE_KEY = 'nv-employee-information';
