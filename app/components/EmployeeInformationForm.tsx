...
const buildInitialFormData = (defaultState: string) => ({
  personal: {
    firstName: '',
    lastName: '',
    middleInitial: '',
...
export default function EmployeeInformationForm({
  ...
  const [formData, setFormData] = useState(() => buildInitialFormData(stateCode.toUpperCase()));
  ...
  const handleFieldChange = (section: keyof typeof formData, field: string) => (
  ...
  const handleBack = () => {
    if (previousFormId) {
      router.push(`${basePath}/form-viewer?form=${previousFormId}`);
    } else {
      router.push(basePath);
    }
  };
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5', padding: '24px' }}>
      ...
      >
        <div style={{ marginBottom: '24px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: '32px', margin: '12px 0 0 0' }}>{stateName} Employee Information Form</h1>
          <p style={{ fontSize: '16px', color: '#666', marginTop: '10px' }}>
            This web form mirrors the official Employee Information packet step so you can stay in the browser and move on to the next documents.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <div style={{ marginTop: '12px', display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              {formData.signature && <span style={{ fontSize: '12px', color: '#4caf50' }}>Signature captured</span>}
            </div>
          </div>
        </div>
