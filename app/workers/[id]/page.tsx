...
export default function WorkerProfilePage() {
  ...
  // Fetch onboarding form templates after worker is loaded
  useEffect(() => {
              ...
              <div className="apple-card p-6 space-y-6">
                ...
                <div className="mt-6 flex flex-wrap gap-6 text-sm text-gray-500">
                  ...
                  <p className="text-xs text-gray-400 self-end">
                    Workers earn 1 sick day per completed month worked.
                  </p>
                </div>
                ...
                {(pdfLoading || templatesLoading) ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      {!employee?.state
                        ? 'Worker has no state assigned'
                        : 'No templates configured for this state or worker has not submitted forms yet'
                      }
                    </p>
