        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage users, vendors, and system settings</p>
            </div>
            <Link
              href="/"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Background Checks Done</p>
                <p className="text-2xl font-bold text-gray-900">{stats.backgroundChecksCompleted}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-red-500">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Temporary Passwords</p>
                <p className="text-2xl font-bold text-gray-900">{stats.temporaryPasswords}</p>
              </div>
            </div>
          </div>
        </div>
