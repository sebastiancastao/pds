...
const PACKET_FORM_PRESETS: PacketFormPreset[] = [
  ...
  { code: 'ca-temp-agreement-la-norcal', label: 'Temp Agreement (LA/NorCal)', description: 'Temporary Employment Agreement — LA Region & NorCal', state: 'CA', formType: 'temp-employment-agreement', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'ca-temp-agreement-sd',        label: 'Temp Agreement (SD)',        description: 'Temporary Employment Agreement — San Diego',          state: 'CA', formType: 'temp-employment-agreement', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  // Arizona
