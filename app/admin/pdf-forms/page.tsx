...
const PACKET_FORM_PRESETS: PacketFormPreset[] = [
  ...
  { code: 'ca-temp-agreement-sd',        label: 'Temp Agreement (SD)',        description: 'Temporary Employment Agreement — San Diego',          state: 'CA', formType: 'temp-employment-agreement?region=san-diego', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  // Arizona
