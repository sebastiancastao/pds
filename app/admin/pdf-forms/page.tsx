...
const PACKET_FORM_PRESETS: PacketFormPreset[] = [
  ...
  { code: 'ca-state-tax',            label: 'CA DE-4',               description: 'CA Employee Withholding Certificate (DE-4)',   state: 'CA', formType: 'fillable',             requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'ca-attendance-scheduling-policy', label: 'Attendance & Scheduling Policy', description: 'Part-Time Employee Attendance & Scheduling Policy', state: 'CA', formType: 'attendance-scheduling-policy', deliveryMethod: 'viewer', requiresSignature: true, allowDateInput: false, allowPrintName: false },
  { code: 'ca-smoking-vaping-policy',  label: 'Smoking & Vaping Policy', description: 'Smoking & Vaping Policy Acknowledgment',       state: 'CA', formType: 'smoking-vaping-policy', requiresSignature: true, allowDateInput: true, allowPrintName: true },
  ...
  { code: 'az-state-tax',            label: 'AZ A-4',                description: 'AZ Employee Withholding Certificate (A-4)',    state: 'AZ', formType: 'fillable',             requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'az-attendance-scheduling-policy', label: 'Attendance & Scheduling Policy', description: 'Part-Time Employee Attendance & Scheduling Policy', state: 'AZ', formType: 'attendance-scheduling-policy', deliveryMethod: 'viewer', requiresSignature: true, allowDateInput: false, allowPrintName: false },
  { code: 'az-smoking-vaping-policy',  label: 'Smoking & Vaping Policy', description: 'Smoking & Vaping Policy Acknowledgment',       state: 'AZ', formType: 'smoking-vaping-policy', requiresSignature: true, allowDateInput: true, allowPrintName: true },
  ...
  { code: 'nv-attendance-scheduling-policy', label: 'Attendance & Scheduling Policy', description: 'Part-Time Employee Attendance & Scheduling Policy', state: 'NV', formType: 'attendance-scheduling-policy', deliveryMethod: 'viewer', requiresSignature: true, allowDateInput: false, allowPrintName: false },
  { code: 'nv-smoking-vaping-policy',  label: 'Smoking & Vaping Policy', description: 'Smoking & Vaping Policy Acknowledgment',       state: 'NV', formType: 'smoking-vaping-policy', requiresSignature: true, allowDateInput: true, allowPrintName: true },
  ...
  { code: 'ny-state-tax',            label: 'NY IT-2104',            description: 'NY State Withholding Certificate (IT-2104)',   state: 'NY', formType: 'fillable',             requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'ny-attendance-scheduling-policy', label: 'Attendance & Scheduling Policy', description: 'Part-Time Employee Attendance & Scheduling Policy', state: 'NY', formType: 'attendance-scheduling-policy', deliveryMethod: 'viewer', requiresSignature: true, allowDateInput: false, allowPrintName: false },
  { code: 'ny-smoking-vaping-policy',  label: 'Smoking & Vaping Policy', description: 'Smoking & Vaping Policy Acknowledgment',       state: 'NY', formType: 'smoking-vaping-policy', requiresSignature: true, allowDateInput: true, allowPrintName: true },
  ...
  { code: 'wi-state-tax',            label: 'WI WT-4',               description: 'WI Withholding Exemption Certificate (WT-4)',  state: 'WI', formType: 'fillable',             requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'wi-attendance-scheduling-policy', label: 'Attendance & Scheduling Policy', description: 'Part-Time Employee Attendance & Scheduling Policy', state: 'WI', formType: 'attendance-scheduling-policy', deliveryMethod: 'viewer', requiresSignature: true, allowDateInput: false, allowPrintName: false },
  { code: 'wi-smoking-vaping-policy',  label: 'Smoking & Vaping Policy', description: 'Smoking & Vaping Policy Acknowledgment',       state: 'WI', formType: 'smoking-vaping-policy', requiresSignature: true, allowDateInput: true, allowPrintName: true },
