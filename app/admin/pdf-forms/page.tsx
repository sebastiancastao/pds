...
const PACKET_FORM_PRESETS: PacketFormPreset[] = [
  ...
  { code: 'ca-meal-waiver-6hour',    label: 'Rest & Meal 6hr',      description: '6-Hour Meal Period Waiver',                   state: 'CA', formType: 'meal-waiver-6hour',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'ca-meal-waiver-10-12',    label: 'Rest & Meal 10/12hr',  description: '10/12-Hour Meal Period Waiver',               state: 'CA', formType: 'meal-waiver-10-12',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'az-meal-waiver-6hour',    label: 'Rest & Meal 6hr',      description: '6-Hour Meal Period Waiver',                   state: 'AZ', formType: 'meal-waiver-6hour',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'az-meal-waiver-10-12',    label: 'Rest & Meal 10/12hr',  description: '10/12-Hour Meal Period Waiver',               state: 'AZ', formType: 'meal-waiver-10-12',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'nv-meal-waiver-6hour',    label: 'Rest & Meal 6hr',      description: '6-Hour Meal Period Waiver',                   state: 'NV', formType: 'meal-waiver-6hour',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'nv-meal-waiver-10-12',    label: 'Rest & Meal 10/12hr',  description: '10/12-Hour Meal Period Waiver',               state: 'NV', formType: 'meal-waiver-10-12',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'ny-meal-waiver-6hour',    label: 'Rest & Meal 6hr',      description: '6-Hour Meal Period Waiver',                   state: 'NY', formType: 'meal-waiver-6hour',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'ny-meal-waiver-10-12',    label: 'Rest & Meal 10/12hr',  description: '10/12-Hour Meal Period Waiver',               state: 'NY', formType: 'meal-waiver-10-12',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  ...
  { code: 'wi-meal-waiver-6hour',    label: 'Rest & Meal 6hr',      description: '6-Hour Meal Period Waiver',                   state: 'WI', formType: 'meal-waiver-6hour',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
  { code: 'wi-meal-waiver-10-12',    label: 'Rest & Meal 10/12hr',  description: '10/12-Hour Meal Period Waiver',               state: 'WI', formType: 'meal-waiver-10-12',    deliveryMethod: 'viewer', requiresSignature: true,  allowDateInput: false, allowPrintName: false },
