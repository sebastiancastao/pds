...
The PDS Time keepingSystem now supports temporary passwords for secure user onboarding and password resets. This feature ensures users change their passwords on first login and provides time-based password expiration.
