...
## Overview
This document compares two approaches for storing profile photos in the PDS Employee Time keepingSystem:
...
For the PDS Employee Time keepingSystem, I recommend the **URL Reference Storage** approach because:
