...
The PDS Time keepingSystem now uses **TOTP (Time-based One-Time Password)** via authenticator apps as the primary MFA method, with **email verification codes** as a fallback option and **backup codes** for emergency access.
