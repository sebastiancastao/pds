...
CREATE INDEX idx_onboarding_form_templates_state ON onboarding_form_templates(state_code);
CREATE INDEX idx_onboarding_form_templates_category ON onboarding_form_templates(form_category);
CREATE INDEX idx_onboarding_form_templates_active ON onboarding_form_templates(is_active);
